...
namespace SmartCertify.Application.Services
{
    public class ChoiceService : IChoiceService
    {
        ...
        public async Task AddChoicesAsync(IEnumerable<CreateChoiceDto> dtos)
        {
            var choices = _mapper.Map<IEnumerable<Choice>>(dtos);
            await _choiceRepository.AddChoicesAsync(choices);
        }
